...
<DownloadButtonGroup>
  <DownloadButton href="https://mutimetroo.com/downloads/muti-metroo/muti-metroo-darwin-arm64" primary>
...
<DownloadButtonGroup>
  <DownloadButton href="https://mutimetroo.com/downloads/muti-metroo/muti-metroo-darwin-amd64" primary>
...
curl -L -o muti-metroo https://mutimetroo.com/downloads/muti-metroo/muti-metroo-darwin-arm64
...
<DownloadButtonGroup>
  <DownloadButton href="https://mutimetroo.com/downloads/muti-metroo/muti-metroo-linux-amd64" primary>
...
<DownloadButtonGroup>
  <DownloadButton href="https://mutimetroo.com/downloads/muti-metroo/muti-metroo-linux-arm64" primary>
...
<DownloadButtonGroup>
  <DownloadButton href="https://mutimetroo.com/downloads/muti-metroo/muti-metroo-windows-amd64.exe" primary>
    Download (.exe)
  </DownloadButton>
</DownloadButtonGroup>
...
<DownloadButtonGroup>
  <DownloadButton href="https://mutimetroo.com/downloads/muti-metroo/muti-metroo-windows-arm64.exe" primary>
    Download ARM64 (.exe)
  </DownloadButton>
</DownloadButtonGroup>
...
<DownloadButtonGroup>
  <DownloadButton href="https://mutimetroo.com/downloads/muti-metroo/checksums.txt">Download Checksums</DownloadButton>
</DownloadButtonGroup>
...
```bash
# Download checksums
curl -L -o checksums.txt https://mutimetroo.com/downloads/muti-metroo/checksums.txt
